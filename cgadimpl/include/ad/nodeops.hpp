...
AG_NODISCARD inline std::shared_ptr<Node> operator*(const std::shared_ptr<Node>& a, float b){ return flomul_nodeops(a,b);}
AG_NODISCARD inline std::shared_ptr<Node> operator*( float b, const std::shared_ptr<Node>& a){ return flomul_nodeops(a,b);}
AG_NODISCARD inline std::shared_ptr<Node> operator/( float b, const std::shared_ptr<Node>& a){ return flodiv_nodeops(b,a);}
AG_NODISCARD inline std::shared_ptr<Node> operator+( float b, const std::shared_ptr<Node>& a){ return floadd_nodeops(b,a);}
AG_NODISCARD inline std::shared_ptr<Node> operator+( const std::shared_ptr<Node>& a, float b){ return floadd_nodeops(b,a);}
...
AG_NODISCARD std::shared_ptr<Node> gcu_nodeops(const std::shared_ptr<Node>& x);
...
AG_NODISCARD std::shared_ptr<Node> relumask_nodeops(const std::shared_ptr<Node>& x);
...
AG_NODISCARD std::shared_ptr<Node> moewe_nodeops(const std::shared_ptr<Node>& x, const std::shared_ptr<Node>& w, const std::shared_ptr<Node>& b);
AG_NODISCARD std::shared_ptr<Node> reluatt_nodeops(const std::shared_ptr<Node>& a, const std::shared_ptr<Node>& b, const std::shared_ptr<Node>& c, const std::shared_ptr<Node>& d);
AG_NODISCARD std::shared_ptr<Node> sigatt_nodeops(const std::shared_ptr<Node>& a, const std::shared_ptr<Node>& b, const std::shared_ptr<Node>& c, const std::shared_ptr<Node>& d);
...
AG_NODISCARD std::shared_ptr<Node> relaynor_nodeops(const std::shared_ptr<Node>& x, float& b, float& g); // with learned scale and bias
AG_NODISCARD std::shared_ptr<Node> mambassm_nodeops(const std::shared_ptr<Node>& z, const std::shared_ptr<Node>& a, const std::shared_ptr<Node>& b, const std::shared_ptr<Node>& c, const std::shared_ptr<Node>& d); // state space model
...
AG_NODISCARD std::shared_ptr<Node> alibiatt_nodeops( const std::shared_ptr<Node>& a, const std::shared_ptr<Node>& b, const std::shared_ptr<Node>& c, const std::shared_ptr<Node>& d, float& m); // m = max seq len
